...
25>mo_user_cons&&25>ot_user_cons?a(".imagify-pre-checkout-offers .imagify-modal-title").addClass(".imagify-enough-free"):a(".imagify-enough-free").removeClass(".imagify-enough-free");if(null===monthlies||null===onetimes)c=a(".imagify-pre-checkout-offers"),c.hide().attr("aria-hidden",!0),c.closest(".imagify-modal-views").find(".imagify-popin-message").remove(),c.after('<div class="imagify-popin-message imagify-error"><p>'+imagifyAdmin.labels.errorPriceAPI+"</p></div>");else{a.each(monthlies,function(b,
c){if("free"===c.label)return!0;var d=a(mo_clone).clone();if(!1!==mo_suggested&&2<b-mo_suggested)return!0;classes="";if(mo_user_cons<c.quota&&!1===mo_suggested){classes=" imagify-offer-selected";mo_suggested=b;var e=a(".imagify-pre-checkout-offers").find(".imagify-offer-monthly");l(e,c,"monthly")}d=l(d,c,"monthly",classes);mo_html+=d[0].outerHTML});c=a(mo_html).filter(".imagify-offer-selected").prevAll();if(1<c.length){c=c.length-1;var d=a(mo_html);for(i=0;i<c;i++)delete d[i];mo_html="";for(j=0;j<
d.length;j++)mo_html+=a("<div/>").append(d[j]).html()}a.each(onetimes,function(b,c){var d=a(ot_clone).clone();classes="";if(ot_user_cons<c.quota&&!1===ot_suggested){classes=" imagify-offer-selected";ot_suggested=!0;var e=a(".imagify-pre-checkout-offers").find(".imagify-offer-onetime");l(e,c,"onetime")}d=l(d,c,"onetime",classes);ot_html+=d[0].outerHTML});$mo_tpl.parent().find(".imagify-offer-line")&&$mo_tpl.parent().find(".imagify-offer-line").remove();$mo_tpl.before(mo_html);$ot_tpl.parent().find(".imagify-offer-line")&&
$ot_tpl.parent().find(".imagify-offer-line").remove();$ot_tpl.before(ot_html)}w.find(".imagify-modal-loader").fadeOut(300)});n()})},A=function(b){b.each(function(){a(this).is(":checked")?a(this).closest(".imagify-offer-line").addClass("imagify-offer-selected"):a(this).closest(".imagify-offer-line").removeClass("imagify-offer-selected")});n()},B=function(b){b.each(function(){var b=a(this),d;d=b.parent(".imagify-cart-list-switcher").length?b.closest(".imagify-cart"):b.parent(".imagify-small-options").length?
...
"true"))});n();return b},y=function(){var b=a("#imagify-coupon-code").val();if(""!==b){var c=a(".imagify-coupon-text"),d=c.find("label"),e=a(".imagify-coupon-section"),g=a("#imagify-get-pricing-modal").data("nonce");c.addClass("checking");a.post(ajaxurl,{action:"imagify_check_coupon",coupon:b,imagifynonce:g},function(a){c.removeClass("checking");"false"===a.success?(d.text(imagifyAdmin.labels.errorCouponAPI),e.removeClass("validated").addClass("invalid")):a.data.success?(a="pourcentage"===a.data.coupon_type?
a.data.value+"%":"$"+a.data.value,e.removeClass("invalid").addClass("validated"),d.html(imagifyAdmin.labels.successCouponAPI),d.find(".imagify-coupon-offer").text(a),d.find(".imagify-coupon-word").text(b)):(e.removeClass("validated").addClass("invalid"),d.text(a.data.detail))})}},q=a(".imagify-offer-line").find(".imagify-checkbox"),C=a(".imagify-payment-modal").find(".imagify-radio-line").find("input");A(q);B(C.filter(":checked"));y();setInterval(function(){n()},1E3);q.on("change.imagify",function(){A(a(this))});
C.on("change.imagify",function(){B(a(this))});a("#imagify-get-pricing-modal").on("click.imagify-ajax",function(){F(a(this))});var r=a("#imagify-plans-selection-view"),h=a("#imagify-payment-process-view"),p=a("#imagify-pre-checkout-view"),t=a("#imagify-success-view"),q=a(".imagify-choose-another-plan");a("#imagify-coupon-code").on("blur.imagify",function(){y()}).on("keydown.imagify",function(a){if(13===a.keyCode||32===a.keyCode)return y(),!1});r.hide();h.hide();t.hide();q.on("click.imagify",function(){var b=
a(this),c=b.data("imagify-choose");b.closest(".imagify-modal-views").hide().attr("aria-hidden","true");h.hide().attr("aria-hidden","true");r.fadeIn(300).attr("aria-hidden","false");var d=setInterval(function(){r.find('a[href="#imagify-pricing-tab-'+("plan"==c?"monthly":"onetime")+'"]').trigger("click.imagify");clearInterval(d);d=null},60);return!1});w.on("click.imagify",".imagify-payment-btn-select-plan",function(){var b=a(this),c=b.closest(".imagify-offer-line"),d=b.data("offer"),e=b.attr("data-offer"),
g="imagify-pricing-tab-monthly"===b.closest(".imagify-tab-content").attr("id")?!1:!0,f=g?p.find(".imagify-offer-onetime"):p.find(".imagify-offer-monthly"),b=g?null:b.closest(".imagify-pricing-table").hasClass("imagify-month-selected")?"monthly":"yearly",d=g?x(d[Object.keys(d)[0]].price):x(d[Object.keys(d)[0]].prices,b),h=c.find(".imagify-approx-nb").text(),m=c.find(".imagify-offer-size").text(),l=g?"":'<span class="imagify-price-by">'+c.find(".imagify-price-by").text()+"</span>";r.hide().attr("aria-hidden",
"true");p.fadeIn(300).attr("aria-hidden","false");f.find(".imagify-number-block").html(d+l);f.find(".imagify-approx-nb").text(h);f.find(".imagify-offer-size").text(m);f.attr("data-offer",e);g||(f.find(".imagify-price-add-data").text(c.find(".imagify-price-add-data").text()),"monthly"===b?f.find("#imagify-subscription-monthly").trigger("click.imagify"):f.find("#imagify-subscription-yearly").trigger("click.imagify"),f.find(".imagify-inline-options").find("input:radio:checked").trigger("change.imagify"));
