jQuery(function(b){var x=0<ajaxurl.indexOf("?")?"&":"?";b("#imagify-signup").click(function(a){a.preventDefault();swal({title:imagifyAdmin.labels.signupTitle,html:imagifyAdmin.labels.signupText,confirmButtonText:imagifyAdmin.labels.signupConfirmButtonText,input:"email",closeOnConfirm:!1,allowOutsideClick:!0,showLoaderOnConfirm:!0,customClass:"imagify-sweet-alert imagify-sweet-alert-signup"}).then(function(a){if(""==b.trim(a)||!a)return swal.showInputError(imagifyAdmin.labels.signupErrorEmptyEmail),
!1;b.get(ajaxurl+x+"action=imagify_signup&email="+a+"&imagifysignupnonce="+b("#imagifysignupnonce").val()).done(function(a){a.success?swal({title:imagifyAdmin.labels.signupSuccessTitle,html:imagifyAdmin.labels.signupSuccessText,type:"success",customClass:"imagify-sweet-alert"}):swal.showInputError(a.data)})})});b("#imagify-save-api-key").click(function(a){a.preventDefault();swal({title:imagifyAdmin.labels.saveApiKeyTitle,html:imagifyAdmin.labels.saveApiKeyText,confirmButtonText:imagifyAdmin.labels.saveApiKeyConfirmButtonText,
input:"text",closeOnConfirm:!1,allowOutsideClick:!0,showLoaderOnConfirm:!0,customClass:"imagify-sweet-alert imagify-sweet-alert-signup"}).then(function(a){if(""==b.trim(a)||!a)return swal.showInputError(imagifyAdmin.labels.signupErrorEmptyEmail),!1;b.get(ajaxurl+x+"action=imagify_check_api_key_validity&api_key="+a+"&imagifycheckapikeynonce="+b("#imagifycheckapikeynonce").val()).done(function(a){a.success?swal({title:imagifyAdmin.labels.ApiKeyCheckSuccessTitle,html:imagifyAdmin.labels.ApiKeyCheckSuccessText,
...
z.find(".imagify-modal-loader").hide().show();b.post(ajaxurl,a,function(a){if(a.success){var c=a.data;a=c.monthlies;var c=c.onetimes,e=b("#imagify-offer-monthly-template"),f=b("#imagify-offer-onetime-template"),k=f.html(),m=e.html(),r="",l="",g=!1,n=!1;b.each(a,function(a,c){if("free"===c.label)return!0;var d=c.additional_gb,e=c.annual_cost,f=c.id,k=c.label,r=c.monthly_cost,h=c.quota,g=1E3<=h?h/1E3+" GB":h+" MB",p=b(m).clone(),e={monthly:r,yearly:Math.round(e/12*100)/100};classes="";1E3<h&&!1===n&&
(classes=" imagify-offer-selected",n=!0);p.addClass("imagify-monthly-"+k+classes);p.find(".imagify-offer-size").text(g);p.find(".imagify-approx-nb").text(5*h);p.find(".imagify-price-add-data").text("$"+d);p.find(".imagify-number-block").html(q(e,"monthly"));p.find(".imagify-payment-btn-select-plan").attr("data-offer",'{"'+k+'":{"id":'+f+',"name":"'+g+'","data":'+h+',"dataf":"'+g+'","imgs":'+5*h+',"prices":{"monthly":'+e.monthly+',"yearly":'+e.yearly+',"add":'+d+"}}}");l+=p[0].outerHTML});b.each(c,
function(a,c){var d=c.id,e=c.cost,f=c.label,m=c.quota,l=1E3<=m?m/1E3+" GB":m+" MB",h=b(k).clone();classes="";51E3<m&&!1===g&&(classes=" imagify-offer-selected",g=!0);h.addClass("imagify-onetime-"+f+classes);h.find(".imagify-offer-size").text(l);h.find(".imagify-approx-nb").text(5*m);h.find(".imagify-number-block").html(q(e,"monthly"));h.find(".imagify-payment-btn-select-plan").attr("data-offer",'{"ot'+f+'":{"id":'+d+',"name":"'+l+'","data":'+m+',"dataf":"'+l+'","imgs":'+5*m+',"price":'+e+"}}");r+=
h[0].outerHTML});e.parent().find(".imagify-offer-line")&&e.parent().find(".imagify-offer-line").remove();e.before(l);f.parent().find(".imagify-offer-line")&&f.parent().find(".imagify-offer-line").remove();f.before(r);z.find(".imagify-modal-loader").fadeOut(300)}})},B=function(a){a.each(function(){b(this).is(":checked")?b(this).closest(".imagify-offer-line").addClass("imagify-offer-selected"):b(this).closest(".imagify-offer-line").removeClass("imagify-offer-selected")})},C=function(a){a.each(function(){var a=
