...
z.find(".imagify-modal-loader").hide().show();b.post(ajaxurl,a,function(a){if(a.success){var c=a.data;a=c.monthlies;var c=c.onetimes,e=b("#imagify-offer-monthly-template"),f=b("#imagify-offer-onetime-template"),g=f.html(),l=e.html(),r="",m="",h=!1,n=!1;b.each(a,function(a,c){if("free"===c.label)return!0;var d=c.additional_gb,e=c.annual_cost,f=c.id,g=c.label,r=c.monthly_cost,k=c.quota,h=1E3<=k?k/1E3+" GB":k+" MB",p=b(l).clone(),e={monthly:r,yearly:Math.round(e/12*100)/100};classes="";1E3<k&&!1===n&&
(classes=" imagify-offer-selected",n=!0);p.addClass("imagify-monthly-"+g+classes);p.find(".imagify-offer-size").text(h);p.find(".imagify-approx-nb").text(5*k);p.find(".imagify-price-add-data").text("$"+d);p.find(".imagify-number-block").html(q(e,"monthly"));p.find(".imagify-payment-btn-select-plan").attr("data-offer",'{"'+g+'":{"id":'+f+',"name":"'+h+'","data":'+k+',"dataf":"'+h+'","imgs":'+5*k+',"prices":{"monthly":'+e.monthly+',"yearly":'+e.yearly+',"add":'+d+"}}}");m+=p[0].outerHTML});b.each(c,
function(a,c){var d=c.id,e=c.cost,f=c.label,l=c.quota,m=1E3<=l?l/1E3+" GB":l+" MB",k=b(g).clone();classes="";51E3<l&&!1===h&&(classes=" imagify-offer-selected",h=!0);k.addClass("imagify-onetime-"+f+classes);k.find(".imagify-offer-size").text(m);k.find(".imagify-approx-nb").text(5*l);k.find(".imagify-number-block").html(q(e,"monthly"));k.find(".imagify-payment-btn-select-plan").attr("data-offer",'{"ot'+f+'":{"id":'+d+',"name":"'+m+'","data":'+l+',"dataf":"'+m+'","imgs":'+5*l+',"price":'+e+"}}");r+=
k[0].outerHTML});e.parent().find(".imagify-offer-line")&&e.parent().find(".imagify-offer-line").remove();e.before(m);f.parent().find(".imagify-offer-line")&&f.parent().find(".imagify-offer-line").remove();f.before(r);z.find(".imagify-modal-loader").fadeOut(300)}})},B=function(a){a.each(function(){b(this).is(":checked")?b(this).closest(".imagify-offer-line").addClass("imagify-offer-selected"):b(this).closest(".imagify-offer-line").removeClass("imagify-offer-selected")})},C=function(a){a.each(function(){var a=
...
w=b("#imagify-pre-checkout-view"),t=b("#imagify-success-view"),u=b(".imagify-choose-another-plan"),h=function(a){var d=b("#imagify-payment-iframe"),c=d.attr("src"),e=d.data("src"),f=0,g=0;if("object"===typeof a)if(a.monthly&&(f=a.monthly[Object.keys(a.monthly)[0]].id),a.onetime&&(g=a.onetime[Object.keys(a.onetime)[0]].id,g=999==g?a.onetime[Object.keys(a.onetime)[0]].data:g),a.period){var c=0!==g&&0!==f?",":"",l=b("#imagify-payment-iframe").data("imagify-api");iframe_plans=0!==g?"onetimeplan":"";iframe_plans+=
c;iframe_plans+=0!==f?a.period+"plan":"";iframe_ids=0!==g?g:"";iframe_ids+=c;iframe_ids+=0!==f?f:"";d.attr("src",e+iframe_plans+"/"+iframe_ids+"/"+l)}else imagifyAdmin.labels.info("No period defined");else"string"===typeof a&&""!==c&&(tofind="monthly"===a?"yearly":"monthly",c=c.replace(tofind,a),d.attr("src",c))},A=function(){return b(".imagify-cart").hasClass("imagify-month-selected")?"monthly":"yearly"};v.hide();n.hide();t.hide();u.on("click.imagify",function(){var a=b(this),d=a.data("imagify-choose");
a.closest(".imagify-modal-views").hide().attr("aria-hidden","true");n.hide().attr("aria-hidden","true");v.fadeIn(300).attr("aria-hidden","false");var c=setInterval(function(){v.find('a[href="#imagify-pricing-tab-'+("plan"==d?"monthly":"onetime")+'"]').trigger("click.imagify");clearInterval(c);c=null},60);return!1});z.on("click.imagify",".imagify-payment-btn-select-plan",function(){var a=b(this),d=a.closest(".imagify-offer-line"),c=a.data("offer"),e=a.attr("data-offer"),f="imagify-pricing-tab-monthly"===
a.closest(".imagify-tab-content").attr("id")?!1:!0,g=f?w.find(".imagify-offer-onetime"):w.find(".imagify-offer-monthly"),a=f?null:a.closest(".imagify-pricing-table").hasClass("imagify-month-selected")?"monthly":"yearly",c=f?q(c[Object.keys(c)[0]].price):q(c[Object.keys(c)[0]].prices,a),l=d.find(".imagify-approx-nb").text(),h=d.find(".imagify-offer-size").text(),m=f?"":'<span class="imagify-price-by">'+d.find(".imagify-price-by").text()+"</span>";v.hide().attr("aria-hidden","true");w.fadeIn(300).attr("aria-hidden",
"false");g.find(".imagify-number-block").html(c+m);g.find(".imagify-approx-nb").text(l);g.find(".imagify-offer-size").text(h);g.attr("data-offer",e);f||(g.find(".imagify-price-add-data").text(d.find(".imagify-price-add-data").text()),"monthly"===a?g.find("#imagify-subscription-monthly").trigger("click.imagify"):g.find("#imagify-subscription-yearly").trigger("click.imagify"),g.find(".imagify-inline-options").find("input:radio:checked").trigger("change.imagify"));return!1});b("#imagify-modal-checkout-btn").on("click.imagify",
function(){var a=b(".imagify-offer-monthly"),d=b(".imagify-offer-onetime"),c={},e=a.hasClass("imagify-year-selected")?"year":"month";a.hasClass("imagify-offer-selected")?(c.monthly=JSON.parse(a.attr("data-offer")),b(".imagify-cart-list-my-choice").show(),prices=c.monthly[Object.keys(c.monthly)[0]].prices,save_price=Math.round(1200*(prices.monthly-prices.yearly))/100,b(".imagify-nb-save-per-year").text("$"+save_price)):b(".imagify-cart-list-my-choice").hide();d.hasClass("imagify-offer-selected")&&
(c.onetime=JSON.parse(d.attr("data-offer")));w.hide().attr("aria-hidden","true");n.fadeIn(300).attr("aria-hidden","false");b(".imagify-cart-emptied-item").hide().attr("aria-hidden","true");b("#imagify-pricing-step-2").addClass("active");n.find(".imagify-cart-item").hide().attr("data-offer","");b.each(c,function(a,c){var d=n.find(".imagify-cart-item-"+a),h=c[Object.keys(c)[0]],m=b(".imagify-cart");d.show();d.attr("data-offer",JSON.stringify(c));d.find(".imagify-the-product-name").text(h.name);d.find(".imagify-cart-offer-data").text(h.dataf);
"onetime"===a?d.find(".imagify-number-block").html(q(h.price)):d.find(".imagify-number-block").find(".imagify-switch-my").html(q(h.prices,e+"ly"));m.removeClass("imagify-month-selected imagify-year-selected").addClass("imagify-"+e+"-selected");"month"===e?m.find("#imagify-checkout-monthly").trigger("click.imagify"):m.find("#imagify-checkout-yearly").trigger("click.imagify");m.find(".imagify-inline-options").find("input:radio:checked").trigger("change.imagify")});c.period=A();h(c);return!1});b(".imagify-remove-from-cart").on("click.imagify",
function(){var a=b(this).closest(".imagify-cart-item"),d=a.hasClass("imagify-cart-item-monthly"),c=d?b(".imagify-cart-item-onetime"):b(".imagify-cart-item-monthly"),e=c.hasClass("imagify-temporary-removed"),f=a.attr("data-offer"),c=e?null:c.data("offer");a.hide().attr("aria-hidden","true").attr("data-offer","").addClass("imagify-temporary-removed");a.next(".imagify-cart-emptied-item").fadeIn(300).attr("aria-hidden","false").attr("data-offer",f).find(".imagify-removed-name").html(a.find(".imagify-cart-product-name").html());
"function"===typeof h?null!==c?(a={},a[d?"onetime":"monthly"]=c,a.period=A(),h(a)):imagifyAdmin.labels.info("No offers selected"):imagifyAdmin.labels.info("imagify_iframe_set_src seems to be not declared");return!1});b(".imagify-cancel-removing").on("click.imagify",function(){var a=b(this).closest(".imagify-cart-emptied-item"),d=a.prev(".imagify-cart-item").hasClass("imagify-cart-item-monthly"),c=d?b(".imagify-cart-item-onetime"):b(".imagify-cart-item-monthly"),e=c.hasClass("imagify-temporary-removed"),
f=a.attr("data-offer"),c=e?null:c.data("offer");a.hide().attr("aria-hidden","true").attr("data-offer","").prev(".imagify-cart-item").fadeIn(300).attr("aria-hidden","true").attr("data-offer",f).removeClass("imagify-temporary-removed");a={};a.monthly=d?JSON.parse(f):c;a.onetime=d?c:JSON.parse(f);a.period=A();"function"===typeof h?h(a):imagifyAdmin.labels.info("imagify_iframe_set_src seems to be not declared\u2026");return!1});b(".imagify-cart-list-my-choice").find('input[type="radio"]').on("change.imagify",
