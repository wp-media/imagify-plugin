...
e.find(".imagify-monthly").attr("aria-hidden","true"),e.find(".imagify-yearly").attr("aria-hidden","false")):(d.addClass("imagify-month-selected").removeClass("imagify-year-selected"),e.find(".imagify-monthly").attr("aria-hidden","false"),e.find(".imagify-yearly").attr("aria-hidden","true"))});n();return b},F=function(){var b=a("#imagify-coupon-code").val();if(""!==b){var c=a(".imagify-coupon-text label"),d=a(".imagify-coupon-section"),e=a("#imagify-get-pricing-modal").data("nonce");a.post(ajaxurl,
{action:"imagify_check_coupon",coupon:b,imagifynonce:e},function(a){"false"===a.success?(c.text(imagifyAdmin.labels.errorCouponAPI),d.removeClass("validated").addClass("invalid")):(c.text(a.data.detail),a.data.success?d.removeClass("invalid").addClass("validated"):d.removeClass("validated").addClass("invalid"))})}},q=a(".imagify-offer-line").find(".imagify-checkbox"),B=a(".imagify-payment-modal").find(".imagify-radio-line").find("input");z(q);A(B.filter(":checked"));setInterval(function(){n()},1E3);
q.on("change.imagify",function(){z(a(this))});B.on("change.imagify",function(){A(a(this))});a("#imagify-get-pricing-modal").on("click.imagify-ajax",function(){E(a(this))});var r=a("#imagify-plans-selection-view"),h=a("#imagify-payment-process-view"),p=a("#imagify-pre-checkout-view"),t=a("#imagify-success-view"),q=a(".imagify-choose-another-plan");a("#imagify-coupon-code").on("blur.imagify",function(){F()});r.hide();h.hide();t.hide();q.on("click.imagify",function(){var b=a(this),c=b.data("imagify-choose");
b.closest(".imagify-modal-views").hide().attr("aria-hidden","true");h.hide().attr("aria-hidden","true");r.fadeIn(300).attr("aria-hidden","false");var d=setInterval(function(){r.find('a[href="#imagify-pricing-tab-'+("plan"==c?"monthly":"onetime")+'"]').trigger("click.imagify");clearInterval(d);d=null},60);return!1});w.on("click.imagify",".imagify-payment-btn-select-plan",function(){var b=a(this),c=b.closest(".imagify-offer-line"),d=b.data("offer"),e=b.attr("data-offer"),g="imagify-pricing-tab-monthly"===
b.closest(".imagify-tab-content").attr("id")?!1:!0,f=g?p.find(".imagify-offer-onetime"):p.find(".imagify-offer-monthly"),b=g?null:b.closest(".imagify-pricing-table").hasClass("imagify-month-selected")?"monthly":"yearly",d=g?x(d[Object.keys(d)[0]].price):x(d[Object.keys(d)[0]].prices,b),h=c.find(".imagify-approx-nb").text(),m=c.find(".imagify-offer-size").text(),l=g?"":'<span class="imagify-price-by">'+c.find(".imagify-price-by").text()+"</span>";r.hide().attr("aria-hidden","true");p.fadeIn(300).attr("aria-hidden",
"false");f.find(".imagify-number-block").html(d+l);f.find(".imagify-approx-nb").text(h);f.find(".imagify-offer-size").text(m);f.attr("data-offer",e);g||(f.find(".imagify-price-add-data").text(c.find(".imagify-price-add-data").text()),"monthly"===b?f.find("#imagify-subscription-monthly").trigger("click.imagify"):f.find("#imagify-subscription-yearly").trigger("click.imagify"),f.find(".imagify-inline-options").find("input:radio:checked").trigger("change.imagify"));n();return!1});a("#imagify-modal-checkout-btn").on("click.imagify",
function(){if(!a(this).hasClass("imagify-button-disabled")){var b=a(".imagify-offer-monthly"),c=a(".imagify-offer-onetime"),d={};b.hasClass("imagify-year-selected");b.hasClass("imagify-offer-selected")?(d.monthly=JSON.parse(b.attr("data-offer")),a(".imagify-cart-list-my-choice").show(),prices=d.monthly[Object.keys(d.monthly)[0]].prices,save_price=Math.round(1200*(prices.monthly-prices.yearly))/100,a(".imagify-nb-save-per-year").text("$"+save_price)):a(".imagify-cart-list-my-choice").hide();c.hasClass("imagify-offer-selected")&&
(d.onetime=JSON.parse(c.attr("data-offer")));p.hide().attr("aria-hidden","true");h.fadeIn(300).attr("aria-hidden","false").closest(".imagify-modal-content").addClass("imagify-iframe-viewing");d.period=a(".imagify-offer-monthly").hasClass("imagify-month-selected")?"monthly":"yearly";var b=a("#imagify-payment-iframe"),e=b.attr("src"),c=b.data("src"),g=0,f=0;"object"===typeof d?(d.monthly&&(g=d.monthly[Object.keys(d.monthly)[0]].id),d.onetime&&(f=d.onetime[Object.keys(d.onetime)[0]].id,f=999==f?d.onetime[Object.keys(d.onetime)[0]].data:
f),d.period?(a("#imagify-payment-iframe").data("imagify-api"),e=f,f="yearly"===d.period?g:0,d="monthly"===d.period?g:0,g=a("#imagify-coupon-code").val(),g=""===g?"none":g,parseFloat(a(".imagify-global-amount").text()).toFixed(2),c=c+e+"/"+d+"/"+f+"/"+g+"/",$iframeClone=b.clone(),b.remove(),$iframeClone.attr("src",c),h.html($iframeClone)):C.info("No period defined")):"string"===typeof d&&""!==e&&(tofind="monthly"===d?"yearly":"monthly",e=e.replace(tofind,d),b.attr("src",e));return!1}});a(".imagify-back-to-plans").on("click.imagify",
function(){a(this).closest(".imagify-cart-item").hasClass("imagify-cart-item-onetime")?a(".imagify-offer-onetime").find(".imagify-choose-another-plan").trigger("click.imagify"):a(".imagify-offer-monthly").find(".imagify-choose-another-plan").trigger("click.imagify");return!1});window.addEventListener("message",function(b){var c=b.origin||b.originalEvent.origin;if("https://app.imagify.io"===c||"http://dapp.imagify.io"===c)switch(b.data){case "cancel":a(".imagify-iframe-viewing .close-btn").trigger("click.imagify");
a(".imagify-iframe-viewing").removeClass("imagify-iframe-viewing");break;case "back":a(".imagify-iframe-viewing").removeClass("imagify-iframe-viewing");h.hide();p.fadeIn(200);break;case "success":a(".imagify-iframe-viewing").removeClass("imagify-iframe-viewing"),h.hide(),t.closest(".imagify-modal-content").addClass("imagify-success-viewing"),t.closest(".imagify-modal").attr("aria-labelledby","imagify-success-view"),t.fadeIn(200)}},!0)}if(a(".imagify-tabs").length)a(".imagify-tab").on("click.imagify",
