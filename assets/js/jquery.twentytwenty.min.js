...
(b.closest(".imagify-modal-content").removeClass("loading").addClass("loaded"),f(a(".imagify-level-ultra").find(".imagify-chart").find("canvas")),console.log("initialised"))}),clearInterval(A),A=null)},75);a(".imagify-comparison-title").on("click",".twentytwenty-duo-buttons button:not(.selected)",function(b){b.stopPropagation();var c=a(this);b=c.closest(".imagify-comparison-title").nextAll(".twentytwenty-wrapper").find(".twentytwenty-container");var d=c.closest(".twentytwenty-duo-buttons").hasClass("twentytwenty-duo-left")?
