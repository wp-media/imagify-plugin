...
namespace Imagify\Tests\Integration\classes\Abilities\UpdateSettings;

use Imagify\Tests\Integration\TestCase;

/**
 * Integration tests for imagify/update-settings ability registration and permissions.
 *
 * @group Abilities
 */
class RegisterAbilityTest extends TestCase {{
	 ...
	 * Ability ID.
	 */
	private const ABILITY_ID = 'imagify/update-settings';
