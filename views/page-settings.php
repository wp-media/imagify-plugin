				...
				<div class="imagify-col imagify-shared-with-account-col<?php echo $hidden_class; ?>">
					<div class="imagify-settings-section">
						...
						<p class="imagify-setting-line">
							...
							$info .= __( 'If you are a photographer, you may be interested in this option if you are displaying on your pages some info like the model of your camera. Also, keeping EXIF data can fix some colorimetric problems.', 'imagify' );
