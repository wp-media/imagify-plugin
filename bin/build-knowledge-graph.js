#!/usr/bin/env node
/**
 * Imagify Knowledge Graph Builder
 *
...
const SCAN_DIRS   = ['classes', 'inc', 'bin'];
const ASSET_DIRS  = ['assets', '_dev/src'];
...
Run \`node bin/build-knowledge-graph.js\` to refresh after significant changes.
`);
		console.log('──────────────────────────────────────────────────────────────');
	}
}
