 ...
 *
 * @since 1.9 // Update this version number accordingly
 */
class Display {
	 ...
	 * @since 1.9 // Update this version number accordingly
	 */
	const OPTION_VALUE = 'rewrite_avif'; // Adjust accordingly
	...
	public function init() {
		...
		// Add your additional initialization logic here, similar to the Display class.
	}
