	...
	<?php
		...
		?>
			<div class="<?php echo $hidden_class; ?>">
				<p><?php _e( 'Nous pouvons aussi analyser vos besoins pour éviter de vous faire acheter n’importe quel plan.', 'imagify' ); ?><br>
				<?php _e( 'Notre analyse vous permettra de choisir le meilleur plan pour votre utilisation.', 'imagify' ); ?></p>
