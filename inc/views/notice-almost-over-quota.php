...
<p>
	<?php _e( 'You are running out of credit! Don’t forget to upgrade your Imagify’s account.', 'imagify' ); ?>

	<a target="_blank" class="button imagify-button imagify-button-secondary button-mini" href="<?php echo esc_url( imagify_get_external_url( 'subscription' ) ); ?>"><?php echo __( 'See our plans', 'imagify' ); ?></a>
</p>
<?php
