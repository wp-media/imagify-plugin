	...
	*/
	if ( isset( $current_screen ) && 'media_page_imagify-bulk-optimization' === $current_screen->base ) {
		...
		$bulk_data = array(
			...
			'getUnoptimizedImagesErrorText'     => __( 'An unknow error ocurred when we tried to get all your unoptimized images. Try again and if the issue still persist, please contact us!', 'imagify' ),
