		...
		<div class="imagify-settings-section">
			...
			<div class="imagify-columns">
				...
				<div class="col-1-3 col-overview">
					...
					<p class="imagify-global-optim-phrase imagify-clear"><?php printf( esc_html__( 'You optimized %s of the images on your website', 'imagify' ), '<span class="imagify-total-percent">' . imagify_percent_optimized_attachments() . '%</span>' ); ?></p>
				</div>
