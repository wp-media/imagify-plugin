			...
			<div class="imagify-columns">
				...
				<div class="col-1-3 col-informations">
					...
					<div class="imagify-bulk-submit">
						...
						<p>
							<?php wp_nonce_field( 'imagify-bulk-upload' ); ?>
				...
				<div class="col-1-3">
					...
					<div class="imagify-chart-container">
						...
						<?php
						if ( $optimized_percent = imagify_percent_optimized_attachments() ) {
							echo '<div id="imagify-overview-chart-percent" class="imagify-chart-percent">' . $optimized_percent . '<span>%</span></div>';
						}
						?>
					</div>
		...
		<div class="imagify-bulk-table">
			<table summary="<?php _e( 'Compression process results', 'imagify' ); ?>">
				...
				<tbody>
					...
					<tr class="imagify-row-complete hidden">
						<td colspan="7">
