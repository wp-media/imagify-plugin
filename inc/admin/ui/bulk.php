			...
			<div class="imagify-columns">
				...
				<div class="col-1-3 col-statistics">
					...
					<div class="imagify-bars">
						...
						<div id="imagify-original-bar" class="imagify-bar-negative base-transparent right-outside-number">
						...
						<div id="imagify-optimized-bar" class="imagify-bar-positive base-transparent right-outside-number">
