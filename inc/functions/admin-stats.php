...
function imagify_count_error_attachments() {
	$transient = IMAGIFY_SLUG . '_count_error_attachments';
	...
	if ( ! $count ) {
		...
		set_transient( $transient, $query->post_count );
	}
...
function imagify_count_optimized_attachments() {
	$transient = IMAGIFY_SLUG . '_count_optimized_attachments';
	$count 	   = get_transient( $transient );
...
function imagify_count_saving_data( $key = '' ) {
	$transient = IMAGIFY_SLUG . '_count_saving_data';
