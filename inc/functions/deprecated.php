...
if ( is_admin() ) :
	...
	function _imagify_correct_capability_for_options_page() {
		_deprecated_function( __FUNCTION__ . '()', '1.6.13', 'Imagify_Settings::get_instance()->get_capability()' );
	...
	function _imagify_register_setting() {
		_deprecated_function( __FUNCTION__ . '()', '1.6.13', 'Imagify_Settings::get_instance()->register()' );
	...
	function _imagify_pre_update_option( $value, $old_value ) {
		_deprecated_function( __FUNCTION__ . '()', '1.6.13', 'Imagify_Settings::get_instance()->sanitize_and_validate( $value )' );
	...
	function _imagify_maybe_set_redirection_before_save_options( $value, $old_value ) {
		_deprecated_function( __FUNCTION__ . '()', '1.6.13', 'Imagify_Settings::get_instance()->maybe_set_redirection( $value, $old_value )' );
	...
	function _imagify_after_save_network_options( $option, $value, $old_value ) {
		_deprecated_function( __FUNCTION__ . '()', '1.6.13', 'Imagify_Settings::get_instance()->after_save_network_options( $option, $value, $old_value )' );
	...
	function _imagify_after_save_options( $old_value, $value ) {
		_deprecated_function( __FUNCTION__ . '()', '1.6.13', 'Imagify_Settings::get_instance()->after_save_options( $old_value, $value )' );
	...
	function _imagify_update_site_option_on_network() {
		_deprecated_function( __FUNCTION__ . '()', '1.6.13', 'Imagify_Settings::get_instance()->update_site_option_on_network()' );
